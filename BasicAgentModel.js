...
var caregivers = [
  {"type":DOCTOR,"label":"Cashier Linda","location":{"row":doctorRow,"col":doctorCol},"state":IDLE},
...
var areas =[
 {"label":"Waiting Area","startRow":17,"numRows":1,"startCol":27,"numCols":9,"color":"pink"},
...
var currentTime = 0;
var statistics = [
{"name":"Average time spent in CrookedCook, Students: ","location":{"row":doctorRow,"col":2},"cumulativeValue":0,"count":0},
 {"name":"Average time spent in CrookedCook, Faculty: ","location":{"row":doctorRow+1,"col":2},"cumulativeValue":0,"count":0},
{"name":"Number of Customers missed: ","location":{"row":doctorRow+2,"col":2},"cumulativeValue":0,"count":0}
];
...
function updateSurface(){
  ...
  var alltables = surface.selectAll(".tables").data(tablesIN);
 	...
 	newtables.append("svg:image")
 	 .attr("x",function(d){var cell= getLocationCell(d.location); return cell.x+"px";})
 	 .attr("y",function(d){var cell= getLocationCell(d.location); return cell.y+"px";})
 	 .attr("width", Math.min(50,50)+"px")
 	 .attr("height", Math.min(50,50)+"px")
...
function addDynamicAgents(){
	...
	if (Math.random()< probArrival){
		var newpatient = {"id":1,"type":"A","location":{"row":25,"col":20},
